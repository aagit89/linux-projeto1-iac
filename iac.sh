...
useradd julio -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_ADM
useradd eliana -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_ADM
...
useradd mauro -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_SEC
